...
void RobotMap::init() {
    ...
    flipperSublimitFipper.reset(new DigitalInput(8));
    ...
    //boulderIntakeintakeBeltMotor.reset(new SD540(8));
    //lw->AddActuator("BoulderIntake", "intakeBeltMotor", std::static_pointer_cast<SD540>(boulderIntakeintakeBeltMotor));
    

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

      launcherleftMotor.get()->ConfigNeutralMode(CANSpeedController::kNeutralMode_Coast);
